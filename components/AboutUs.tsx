    ...
    <div id="aboutus" className="flex flex-col items-center">
      ...
      <div className="flex w-[100vw] justify-evenly items-center">
        <div className={cn("text-3xl", hideImage ? "text-center" : "ml-8")}>
          <span className="text-[var(--maindark)] font-bold">Creative Computing Society</span> is back with <span className="text-[var(--maindark)] font-bold">HackTU {HACKATHON_VERSION}.0</span>, our flagship event
          ...
          <span className="text-[var(--maindark)] font-bold">Gear up your tech stack</span>, brainstorm innovative ideas, ignite team spirit,
          and build solutions for real-world problems at <span className="text-[var(--maindark)] font-bold">HackTU {HACKATHON_VERSION}.0</span> - the biggest offline hackathon at TIET!
        </div>
        {hideImage || (
